...
public class ImepayModule extends ReactContextBaseJavaModule {
  ...
  @ReactMethod
  public void makePayment(String MERCHANT_CODE, String MERCHANT_NAME, String MERCHANT_TRANSACTION_RECORDING_URL, String AMOUNT, String REFERENCE_ID, String MODULE, String USERNAME, String PASSWORD, String ENV, Promise promise) {
